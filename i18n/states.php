...
return array(
	...
	'CD' => array( // Cambodian states.
		'BM' => __( 'Banteay Meanchey', 'woocommerce' ),
		'BB' => __( 'Battambang', 'woocommerce' ),
		'KC' => __( 'Kampong Cham', 'woocommerce' ),
		'KN' => __( 'Kampong Chhnang', 'woocommerce' ),
		'KS' => __( 'Kampong Speu', 'woocommerce' ),
		'KT' => __( 'Kampong Thom', 'woocommerce' ),
		'KP' => __( 'Kampot', 'woocommerce' ),
		'KD' => __( 'Kandal', 'woocommerce' ),
		'KK' => __( 'Koh Kong', 'woocommerce' ),
		'KE' => __( 'Kep', 'woocommerce' ),
		'KR' => __( 'Kratie', 'woocommerce' ),
		'MK' => __( 'Mondulkiri', 'woocommerce' ),
		'OM' => __( 'Oddar Meanchey', 'woocommerce' ),
		'PL' => __( 'Pailin', 'woocommerce' ),
		'PP' => __( 'Phnom Penh', 'woocommerce' ),
		'SV' => __( 'Preah Sihanouk', 'woocommerce' ),
		'PR' => __( 'Preah Vihear', 'woocommerce' ),
		'PS' => __( 'Pursat', 'woocommerce' ),
		'PV' => __( 'Prey Veng', 'woocommerce' ),
		'RK' => __( 'Ratanakiri', 'woocommerce' ),
		'SR' => __( 'Siem Reap', 'woocommerce' ),
		'ST' => __( 'Stung Treng', 'woocommerce' ),
		'SG' => __( 'Svay Rieng', 'woocommerce' ),
		'TK' => __( 'Takeo', 'woocommerce' ),
		'TB' => __( 'Tboung Khmum', 'woocommerce' ),
	),
	'CH' => array( // Cantons of Switzerland.
		'AG' => __( 'Aargau', 'woocommerce' ),
		'AR' => __( 'Appenzell Ausserrhoden', 'woocommerce' ),
		'AI' => __( 'Appenzell Innerrhoden', 'woocommStung Trengce' ),
